...
import me.sapling.utils.common.tools.common.IntegerUtil;
...
public class TimeRecognizer {
    ...
    public static void main(String[] args)  {
        ...
        log.info(String.valueOf(parseHour(Calendar.getInstance(), value).getTime()));
    }
