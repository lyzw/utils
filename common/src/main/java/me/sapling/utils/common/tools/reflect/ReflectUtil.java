...
public class ReflectUtil {
     ...
     * @param values 类型的属性值
     * @return 构建后的类型实例
     * @throws IllegalAccessException the currently
     *                                executing method does not have access to the definition of
     *                                the specified class, field, method or constructor.
     * @throws InstantiationException the specified class object cannot be
     *                                instantiated.
     */
    public static <T> T getInstance(Class<T> type, Map<String, Object> values) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
